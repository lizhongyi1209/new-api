...
import {
  MAIN_SITE_FILING_LINKS,
  shouldShowMainSiteFiling,
} from "@/config/main-site-filing";
...
function FilingLinks(props: { leadingSeparator?: boolean }) {
  if (
    ...
    !shouldShowMainSiteFiling(window.location.hostname)
  ) {
    return null;
  }
  ...
  return (
    <>
      {MAIN_SITE_FILING_LINKS.map((link, index) => (

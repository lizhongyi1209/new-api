...
export const TaskUsagePricingEditor = memo(function TaskUsagePricingEditor(
  ...
  const supportsVisual =
    getTaskNumberFields(props.usageSchema).length > 0 &&
    getTaskEnumCombinations(props.usageSchema).length > 0
        ...
        <Field className='gap-2'>
          ...
          >
            ...
            <SelectContent alignItemWithTrigger={false}>
              <SelectGroup>
                <SelectItem value='visual' disabled={!supportsVisual}>{t('Visual editor')}</SelectItem>

...
export const STATIC_I18N_KEYS = [
  // Settled billing units and request-rule status.
  'Per image',
  'Not matched',
  // Billing condition editing, request simulation and conversion diagnostics.
  ...
  'This alias uses Claude cache semantics. Convert its cache TTL prices manually.',
  ...
  'This image alias has model-specific request multipliers. Convert its size and quality rules manually.',

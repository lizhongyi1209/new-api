...
export const useTaskLogsData = () => {
  ...
  const loadLogs = async (page = 1, size = pageSize) => {
    ...
    let url = isAdminUser
      ? `/api/task/?p=${page}&page_size=${size}&channel_id=${channel_id}&task_id=${task_id}&start_timestamp=${localStartTimestamp}&end_timestamp=${localEndTimestamp}&exclude_platform=async_image,generate_image`
      : `/api/task/self?p=${page}&page_size=${size}&task_id=${task_id}&start_timestamp=${localStartTimestamp}&end_timestamp=${localEndTimestamp}&exclude_platform=async_image,generate_image`;

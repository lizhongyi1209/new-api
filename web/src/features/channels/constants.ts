...
> = {
  ...
  60: { descriptionKey: 'Connect to TokenMart Seedance video models' },
  61: { descriptionKey: 'Connect to xinhankr model services' },
  63: { descriptionKey: 'Connect to model services through a Sub2API gateway' },
  64: {
    descriptionKey:
...
const CHANNEL_TYPE_DISPLAY_ORDER: number[] = [
  1, 14, 24, 33, 43, 3, 41, 17, 45, 25, 26, 23, 48, 64, 59, 60, 61, 63, 62, 42, 34, 20,
  4, 65, 40, 27, 15, 46, 18, 31, 35, 49, 19, 47, 37, 38, 39, 11, 8, 57, 22, 21,

...
export default function UploadManagement() {
  ...
  const filesQuery = useQuery({
    ...
    queryFn: async () =>
      requireServerSuccess(
        await getUploadedFiles({ category: category || undefined, page })
      ),
  ...
  const deleteMutation = useMutation({
    mutationFn: async (variables: Parameters<typeof deleteFile>[0]) =>
      requireServerSuccess(await deleteFile(variables)),
    onSuccess: async () => {
  ...
  const batchDeleteMutation = useMutation({
    mutationFn: async (variables: Parameters<typeof batchDeleteFiles>[0]) =>
      requireServerSuccess(await batchDeleteFiles(variables)),
  ...
  const clearMutation = useMutation({
    mutationFn: async () => requireServerSuccess(await clearUploadedFiles()),
    onSuccess: async (result) => {

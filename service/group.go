...
// Missing context means that the token inherits the global Auto list. A present
// value is a token-specific snapshot and never falls back after filtering.
...
// GetGroupsEnabledModels returns enabled models in group-priority order.

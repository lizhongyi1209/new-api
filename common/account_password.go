...
var (
	...
	ErrAccountPasswordCommon = errors.New("This password is too common. Choose a less predictable password.")
...
var commonAccountPasswordList string

var commonAccountPasswords = parseCommonAccountPasswords(commonAccountPasswordList)

func parseCommonAccountPasswords(list string) map[string]struct{} {
	passwords := make(map[string]struct{}, 3000)
...
func ValidateNewAccountPassword(password string) error {
	...
	if _, common := commonAccountPasswords[password]; common {
